...
#import "ARConfigController.h"

@implementation ARCollectionViewCell

@end

@interface ARMainViewController ()<UITextFieldDelegate,ARtmCallDelegate,ARtmDelegate,ARtcEngineDelegate,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
...
- (void)viewDidLoad {
    ...
    if (self.type) {
        ...
        self.rtmCollectionView.collectionViewLayout = self.flowLayout;
    }
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    ARConfigController *configVc = nav.childViewControllers[0];
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout*)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath*)indexPath{
    return CGSizeMake((0.84 * SCREEN_WIDTH - 60)/3, 44);
}

- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ARCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"ARtm_CollectionCell" forIndexPath:indexPath];
