...
@interface ARtmCallViewController ()<ARtcEngineDelegate,ARtmCallDelegate,ARtmDelegate>
...
@implementation ARtmCallViewController
        ...
        case 53:
            {
                ...
                [self initializeRtcKit:self.mode];
            }
            break;
        case 54:
            //切换语音模式
