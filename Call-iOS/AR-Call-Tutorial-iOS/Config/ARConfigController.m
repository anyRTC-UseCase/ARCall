...
@implementation ARConfigMeetCell

@end

@interface ARConfigController ()
...
@implementation ARConfigController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (self.type || indexPath.section == 2) {
        ARConfigMeetCell *meetCell = (ARConfigMeetCell *)cell;
