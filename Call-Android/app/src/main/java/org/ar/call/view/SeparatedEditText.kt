...
import org.ar.call.utils.matchValue
import java.util.*
...
//
    ...
    init {
        ...
        borderColor = ta.getColor(
            R.styleable.SeparatedEditText_borderColor, ContextCompat.getColor(getContext(),
                R.color.colorAccent
            ))
        blockColor = ta.getColor(
            R.styleable.SeparatedEditText_blockColor, ContextCompat.getColor(getContext(),
                R.color.colorPrimary
            ))
        textColor = ta.getColor(
            R.styleable.SeparatedEditText_textColor, ContextCompat.getColor(getContext(),
                R.color.colorAccent
            ))
        highLightColor = ta.getColor(
            R.styleable.SeparatedEditText_highlightColor, ContextCompat.getColor(getContext(),
                R.color.colorAccent
            ))
        highLightBefore = ta.getBoolean(R.styleable.SeparatedEditText_highLightBefore, false)
        cursorColor = ta.getColor(
            R.styleable.SeparatedEditText_cursorColor, ContextCompat.getColor(getContext(),
                R.color.colorAccent
            ))
        ...
        errorColor = ta.getColor(
            R.styleable.SeparatedEditText_errorColor, ContextCompat.getColor(getContext(),
                R.color.colorAccent
            ))
        ta.recycle()
        init()
